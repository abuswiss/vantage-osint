...
export type DashboardFontFamily = 'tajawal';

// Which web-font families the dashboard actually needs for a given locale.
// The default (LTR/non-Arabic) needs none — its body font is the system/mono
// stack — so those users download zero web fonts.
